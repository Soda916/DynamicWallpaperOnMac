...
### Architectural Variants & Download Matrix (v0.1.6-alpha)

| Architecture | Chip Target | Compatibility | Direct Download Links |
| :--- | :--- | :--- | :--- |
| **Universal (Recommended)** | Apple Silicon + Intel | All Macs | [DMG](https://github.com/Soda916/DynamicWallpaperOnMac/releases/download/v0.1.6-alpha/DynamicWallpaperEngine-v0.1.6-alpha-macOS-Universal.dmg) \| [ZIP](https://github.com/Soda916/DynamicWallpaperOnMac/releases/download/v0.1.6-alpha/DynamicWallpaperEngine-v0.1.6-alpha-macOS-Universal.zip) |
| **Apple Silicon** | `arm64` | M1 / M2 / M3 / M4 | [DMG](https://github.com/Soda916/DynamicWallpaperOnMac/releases/download/v0.1.6-alpha/DynamicWallpaperEngine-v0.1.6-alpha-macOS-arm64.dmg) \| [ZIP](https://github.com/Soda916/DynamicWallpaperOnMac/releases/download/v0.1.6-alpha/DynamicWallpaperEngine-v0.1.6-alpha-macOS-arm64.zip) |
| **Intel** | `x86_64` | Intel Macs | [DMG](https://github.com/Soda916/DynamicWallpaperOnMac/releases/download/v0.1.6-alpha/DynamicWallpaperEngine-v0.1.6-alpha-macOS-x86_64.dmg) \| [ZIP](https://github.com/Soda916/DynamicWallpaperOnMac/releases/download/v0.1.6-alpha/DynamicWallpaperEngine-v0.1.6-alpha-macOS-x86_64.zip) |
