...
- ~🧩 **可擴展的 JavaScript 外掛**：內建 QuickJS 執行階段，無須 Node.js 依賴即可啟用桌面時鐘、小工具與動態互動式疊加層。~ (待開發)
...
### 系統架構版本與即時下載表格 (v0.1.5-alpha)

| 系統架構 | 晶片支援 | 設備相容性 | 官方下載連結 (Direct Download) |
| :--- | :--- | :--- | :--- |
| **Universal 通用版 (推薦)** | Apple Silicon + Intel | 所有 Mac 設備 | [DMG 檔](https://github.com/Soda916/DynamicWallpaperOnMac/releases/download/v0.1.5-alpha/DynamicWallpaperEngine-v0.1.5-alpha-macOS-Universal.dmg) \| [ZIP 檔](https://github.com/Soda916/DynamicWallpaperOnMac/releases/download/v0.1.5-alpha/DynamicWallpaperEngine-v0.1.5-alpha-macOS-Universal.zip) |
| **Apple Silicon 專用版** | `arm64` | M1 / M2 / M3 / M4 Mac | [DMG 檔](https://github.com/Soda916/DynamicWallpaperOnMac/releases/download/v0.1.5-alpha/DynamicWallpaperEngine-v0.1.5-alpha-macOS-arm64.dmg) \| [ZIP 檔](https://github.com/Soda916/DynamicWallpaperOnMac/releases/download/v0.1.5-alpha/DynamicWallpaperEngine-v0.1.5-alpha-macOS-arm64.zip) |
| **Intel 專用版** | `x86_64` | Intel Mac | [DMG 檔](https://github.com/Soda916/DynamicWallpaperOnMac/releases/download/v0.1.5-alpha/DynamicWallpaperEngine-v0.1.5-alpha-macOS-x86_64.dmg) \| [ZIP 檔](https://github.com/Soda916/DynamicWallpaperOnMac/releases/download/v0.1.5-alpha/DynamicWallpaperEngine-v0.1.5-alpha-macOS-x86_64.zip) |
